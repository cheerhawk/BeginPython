...
class NewsAgent:
    ...
    def distribute(self):
        """
        Retrieve all news items from all sources, and Distribute them to all destinations.
        """
        items = []
...
class NNTPSource:
    """
    A news sourece that retrieves news items from NNTP group.
    """
...
def runDefaultSetup():
    ...
    # An NNTPSource that retrieves news from com.lang.python.announce:
