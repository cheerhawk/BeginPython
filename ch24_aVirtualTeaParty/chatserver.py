...
class Room(CommandHandler):
    """
    A generic environment that may contain one or more user (sessions).
    ...
    def broadcast(self, line):
        'Send a line to all session in the room'
...
class ChatRoom(Room):
    ...
    def do_look(self, session, line):
        'Handles the look command, used to see who is in room'
